    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        <div className={styles.grid}>
          <div className={styles["manage-logo"]}>
            <Link href="/">
              <a>
          ...
          <div className={styles["logos-continer"]}>
            <ul role="list" aria-label="Social links" className={styles.logos}>
              <li>
              ...
              <li>
                <a href="#" aria-label="twitter" className={styles.logo}>
                  <svg xmlns="http://www.w3.org/2000/svg">
                    <path
                      className={styles.logo}
              ...
              <li>
                <a href="#" aria-label="pinterest" className={styles.logo}>
                  <svg xmlns="http://www.w3.org/2000/svg">
                    <path
                      className={styles.logo}
              ...
              <li>
                <a href="#" aria-label="instagram" className={styles.logo}>
                  <svg xmlns="http://www.w3.org/2000/svg">
                    <path
                      className={styles.logo}
          ...
          <div>
            <nav>
              ...
              <ul className={styles["links-column-two"]}>
                <li>
                  <a href="#">Careers</a>
                </li>
                <li>
